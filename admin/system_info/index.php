...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Contact Us</label>
	             <textarea name="contact_us" id="" cols="30" rows="2" class="form-control summernote"><?php echo  is_file(base_app.'contact.html') ? file_get_contents(base_app.'contact.html') : "" ?></textarea>
			</div>
			<div class="form-group">
